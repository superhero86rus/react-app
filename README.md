...
useCallback - запоминаем функцию, если зависимости не изменились или их нет

useMemo - позволяет замемоизировать (оптимизировать) расчет значений, в отличие от memo + useCallback, которые оптимизируют функции